...
use SCMiley\Rss\MarketWire\RssFeed;

$titles = [];
$companyNames = [];

$todayDisplay = date('Y-m-d');
$normalFilename = __DIR__ . "/../marketWire/marketWire$todayDisplay.csv";
$lowPriorityFilename = __DIR__ . "/../marketWire/marketWire{$todayDisplay}_lowPriority.csv";
